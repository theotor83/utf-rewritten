...
ArchiveForumGroup.objects.get_or_create(name="Royal Guard Apprentice", priority=80, description="""Modérateurs ChatBox.""", is_messages_group=False, minimum_messages=999999, color="#2D3EDF")
...
is_messages_group=False, is_staff_group=True, minimum_messages=999999, color="#C02200")

ArchiveForumGroup.objects.get_or_create(name="Gaster's follower", priority=110, description="""Gaster followers.""", 
is_messages_group=False, is_staff_group=True, minimum_messages=999999, color="#000000")

ArchiveForumGroup.objects.get_or_create(name="UTFbot", priority=120, description="""UTFbot.""", 
is_messages_group=False, is_staff_group=True, minimum_messages=999999, color="#6775AC")
