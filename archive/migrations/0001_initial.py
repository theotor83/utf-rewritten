# Generated by Django 5.1.6 on 2025-06-26 00:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='DEFAULT_CATEGORY_NAME', max_length=6000)),
                ('slug', models.SlugField(blank=True, max_length=25500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#FFFFFF', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('username', models.CharField(blank=True, max_length=15000, null=True)),
                ('email', models.CharField(blank=True, max_length=15000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('title', models.CharField(blank=True, max_length=6000, null=True)),
                ('description', models.CharField(blank=True, max_length=25500, null=True)),
                ('icon', models.CharField(blank=True, max_length=6000, null=True)),
                ('slug', models.SlugField(blank=True, max_length=25500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('title', models.CharField(blank=True, max_length=25500, null=True)),
                ('description', models.CharField(blank=True, max_length=25500, null=True)),
                ('is_hidden', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.CharField(blank=True, max_length=25500, null=True)),
                ('messages_count', models.IntegerField(default=0)),
                ('desc', models.CharField(blank=True, max_length=2000, null=True)),
                ('localisation', models.CharField(blank=True, max_length=25500, null=True)),
                ('loisirs', models.CharField(blank=True, max_length=25500, null=True)),
                ('birthdate', models.DateTimeField()),
                ('type', models.CharField(choices=[('pacifist', 'Pacifiste'), ('neutral', 'Neutre'), ('genocide', 'Génocidaire')], default='neutral', max_length=20, null=True)),
                ('favorite_games', models.CharField(blank=True, max_length=25500, null=True)),
                ...
                ('gender', models.CharField(choices=[('male', 'Masculin'), ('female', 'Féminin')], max_length=20, null=True)),
                ('website', models.CharField(blank=True, max_length=25500, null=True)),
                ('skype', models.CharField(blank=True, max_length=25500, null=True)),
                ('signature', models.TextField(blank=True, max_length=6553500, null=True)),
                ...
                ('is_hidden', models.BooleanField(default=False)),
                ('display_id', models.IntegerField(default=0)),
                ('display_username', models.CharField(blank=True, max_length=25500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('text', models.TextField(default='DEFAULT POST TEXT', max_length=6553500)),
                ('created_time', models.DateTimeField()),
